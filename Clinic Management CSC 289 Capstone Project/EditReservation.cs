...
namespace Clinic_Management_CSC_289_Capstone_Project
{
    public partial class EditReservation : Form
    {
        ...
        public EditReservation(Reservation res)
        {
            ...
            textBox5.Text = res.date.ToString();
        ...
        private void updateCombo(int visit_slot)
        {
            ...
            command.Parameters.AddWithValue("@date", dateTimePicker1.Value.ToString("yyy-MM-dd"));
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (command.ExecuteNonQuery() > 0)
                ...
                MessageBox.Show("Falied to update the reservation!");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (command.ExecuteNonQuery() > 0)
                MessageBox.Show("Reaservation was deleted!");
            else
